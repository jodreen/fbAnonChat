(function() {
    var FB = (function() {
        var request = require('request'),
            ...
            getLoginUrl, pingFacebook, api, napi, nodeifyCallback, graph, rest, oauthRequest, parseOAuthApiResponse, setAccessToken, getAccessToken, parseSignedRequest, base64UrlDecode, log, has, options, METHODS = ['get', 'post', 'delete', 'put'],
            opts = {
                'accessToken': null,
                'appId': null,
                'appSecret': null,
        ...
        oauthRequest = function(domain, path, method, params, cb) {
            var uri, body, key, value, requestOptions, isOAuthRequest, pool;
            ...
            pool = {
                maxSockets: options('maxSockets') || Number(process.env.MAX_SOCKETS) || 5
            };
            requestOptions = {
                method: method,
                uri: uri,
        ...
        parseSignedRequest = function() {
            var args = Array.prototype.slice.call(arguments),
                ...
                split, encodedSignature, encodedEnvelope, envelope, hmac, base64Digest, base64UrlDigest;
        ...
        getLoginUrl = function(opt) {
            ...
            return 'https://www.facebook.com/dialog/oauth' + '?response_type=' + (opt.responseType || opt.response_type || 'code') + scopeQuery + displayQuery + stateQuery + '&redirect_uri=' + encodeURIComponent(redirectUri) + '&client_id=' + clientId;
        };
